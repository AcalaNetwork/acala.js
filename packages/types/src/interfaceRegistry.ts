...
import { ChangeOptionBalance, ChangeOptionRate, ChangeOptionRatio, LiquidationStrategy, OptionBalance, OptionRate, OptionRatio, RiskManagementParams } from '@acala-network/types/interfaces/cdpEngine';
...
import { AccountId, AccountIdOf, AccountIndex, Address, Amount, AmountOf, AssetId, AuctionId, AuctionIdLinkedItem, AuctionIdOf, AuctionItem, Balance, BalanceOf, Block, BlockNumber, Call, ChangesTrieConfiguration, Consensus, ConsensusEngineId, CurrencyIdOf, DebitAmount, DebitAmountOf, DebitBalance, DebitBalanceOf, Digest, DigestItem, DispatchClass, DispatchInfo, DispatchInfoTo190, Fixed128, Fixed64, H160, H256, H512, Hash, Header, Index, Justification, KeyTypeId, KeyValue, LockIdentifier, LookupSource, LookupTarget, ModuleId, Moment, OracleKey, OracleValue, Origin, Perbill, Percent, Permill, Perquintill, Phantom, PhantomData, PreRuntime, RuntimeDbWeight, Seal, SealV0, Share, SignedBlock, StorageData, ValidatorId, Weight, WeightMultiplier } from '@acala-network/types/interfaces/runtime';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<OptionBalance>': Option<OptionBalance>;
    'Vec<OptionBalance>': Vec<OptionBalance>;
    ...
    ChangeOptionBalance: ChangeOptionBalance;
    'Option<ChangeOptionBalance>': Option<ChangeOptionBalance>;
    'Vec<ChangeOptionBalance>': Vec<ChangeOptionBalance>;
    ...
    AuctionIdLinkedItem: AuctionIdLinkedItem;
    'Option<AuctionIdLinkedItem>': Option<AuctionIdLinkedItem>;
    'Vec<AuctionIdLinkedItem>': Vec<AuctionIdLinkedItem>;
    OracleKey: OracleKey;
    ...
    'Option<LiquidBalance>': Option<LiquidBalance>;
    'Vec<LiquidBalance>': Vec<LiquidBalance>;
    StakingBalanceOf: StakingBalanceOf;
    'Option<StakingBalanceOf>': Option<StakingBalanceOf>;
    'Vec<StakingBalanceOf>': Vec<StakingBalanceOf>;
    LiquidBalanceOf: LiquidBalanceOf;
    'Option<LiquidBalanceOf>': Option<LiquidBalanceOf>;
    'Vec<LiquidBalanceOf>': Vec<LiquidBalanceOf>;
