...
import { AcalaPrimitivesCurrencyCurrencyId, AcalaPrimitivesPosition } from '@polkadot/types/lookup';
...
export class LoanRx {
  ...
  private getLoanPosition() {
    return this.api.query.loans.positions(this.currency, this.address) as Observable<AcalaPrimitivesPosition>;
  }
