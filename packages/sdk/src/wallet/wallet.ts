...
import { BelowExistentialDeposit, SDKNotReady } from '../errors.js';
import { ChainType } from '../types.js';
import { Homa } from '../homa/index.js';
import { Liquidity } from '../liquidity/index.js';
import { getMaxAvailableBalance } from './utils/get-max-available-balance.js';
import { MarketPriceProvider } from './price-provider/market-price-provider.js';
import { OraclePriceProvider } from './price-provider/oracle-price-provider.js';
...
import { DexPriceProvider } from './price-provider/dex-price-provider.js';
import { AggregateProvider } from './price-provider/aggregate-price-provider.js';
import { AcalaExpandBalanceAdapter } from './balance-adapter/types.js';
import { AcalaBalanceAdapter } from './balance-adapter/acala.js';
import { TokenProvider } from './token-provider/type.js';
import { AcalaTokenProvider } from './token-provider/acala.js';
        ...
        switchMap(({ nativeToken, feeToken }) => {
          ...
          return combineLatest({
            ...
            map(({ accountInfo, tokenInfo, feeInfo }) => {
              ...
              const nativeLockedBalance = FN.fromInner(accountInfo.data.frozen.toString(), nativeToken.decimals);
